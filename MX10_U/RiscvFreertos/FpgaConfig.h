...
#define MEMADDR_IRQBRIDGE ((uintptr_t)(0x00010000))
#define MEMADDR_PIO       ((uintptr_t)(0x00010100))
#define MEMADDR_UART      ((uintptr_t)(0x00010200))
#define MEMADDR_DDRCSR    ((uintptr_t)(0x00010400))
#define MEMADDR_DDR3      ((uintptr_t)(0x20000000))

#define DDR3_SIZE ((uint32_t)(0x20000000)) // 512 MiB
#define HEAP_OCRAM 1
#define HEAP_DDR3 2
#define HEAP_CONFIG HEAP_DDR3
